...
public class UkMakerSpaces {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Total time: 8.466 secs
        //4:20:38 PM: Execution finished ':UkMakerSpaces.main()'.
    }
    ...
    private static Optional<String> getPostPrefix(String line) {
        ...
        // this part takes a string like AB1 from "AB11 5BN"
        // that is the beggining of Postcode makerSpaceRdd content
    }
    ...
    private static Map<String, String> loadPostCodeMap() throws FileNotFoundException {
        ...
        while (postCode.hasNextLine()) {
            ...
            // this part takes a string like AB1 inside splits[0]
        }
        return postCodeMap;
    }
