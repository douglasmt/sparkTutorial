...
public class StackOverFlowSurvey {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SparkSession session = SparkSession.builder().appName("StackOverFlowSurveyDoug").getOrCreate(); // for AWS

        //spark session for SQL syntax instead of RDD
        // builder method, appName

        DataFrameReader dataFrameReader = session.read();

        Dataset<Row> responses = dataFrameReader.option("header","true").csv("s3://stackoverflow-analytics-doug/2016-stack-overflow-survey-responses.csv");
        // option, provide schema,
        // csv file
        // row - collection of fields
        ...
        //changing the format float to integer
